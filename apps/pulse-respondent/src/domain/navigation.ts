...
export const guidanceItems: GuidanceItem[] = [
  ...
  { id: "dont-know", kind: "tip", scope: "survey", title: "“Don’t know” is useful", body: "You do not need to be an expert in forced labour, people trafficking or labour assurance. Choose “Don’t know” when you are unsure." },
  { id: "optional", kind: "info", scope: "survey", title: "All questions are optional", body: "You can skip any question and submit a partial response whenever you are ready." },
  { id: "autosave", kind: "info", scope: "survey", title: "Responses save automatically", body: "Your progress is kept as you answer, including when you move between the Introduction and survey sections. Saved responses remain on this device." },
  { id: "review", kind: "info", scope: "survey", title: "Review your answers", body: "You can return to any question and review or change your answer at any time." },
  ...
  { id: "submission-verification", kind: "info", scope: "survey", title: "Your token protects your anonymity", body: "We email you a secure token that contains no personally identifiable information. Because it is digitally signed by us, it proves that you are authorised to submit a response, helping prevent spam and automated submissions without identifying you. We do not store a copy, and only you have access to it. The token simply proves that we agreed you could take part, not who you are or how you responded." },
];
